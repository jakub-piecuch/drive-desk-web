...
import { useCreateInstructor } from "../instructor.hooks";
...
export function CreateInstructorModal({ isOpen: open, onOpenChange }: CreateInstructorModalProps) {
  ...
  return (
    <EntityFormModal
      ...
      description="Enter the details for the new instructor."
      isOpen={open}
