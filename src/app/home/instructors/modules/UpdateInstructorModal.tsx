...
import { useUpdateInstructorById } from "../instructor.hooks";
...
export function UpdateInstructorModal({
  id,
  name: currentName,
  ...
  const { mutate: updateInstructor, isPending } = useUpdateInstructorById();
  ...
  return (
    <EntityFormModal
      ...
      description="Update your instructor information."
      isOpen={open}
